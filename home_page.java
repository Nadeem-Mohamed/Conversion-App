...
public class home_page implements ActionListener {
  ...
  public void home() {
    ...
    message.setForeground(new Color(0,0,128));
    ...
    submes.setForeground(new Color(0,0,128));
    ...
    numberbase.setBackground(new Color(0,0,128)); 
    numberbase.setForeground(new Color(255,255,255));
    numberbase.setFont(new Font("Arial", Font.PLAIN,18));
    panel1.add(numberbase);
    JLabel numdes = new JLabel("<html>Convert Numbers to Different Bases Such as Decimal, Binary and Hexadecimal.</html>");
    numdes.setForeground(new Color(0,0,0));
    ...
    measure.setBackground(new Color(0,0,128)); 
    measure.setForeground(new Color(255,255,255));
    measure.setFont(new Font("Arial", Font.PLAIN,18));
    panel2.add(measure);
    JLabel mesdes = new JLabel("<html>Convert Numbers to Different Units in Length, Mass, Time and Temperature.</html>");
    mesdes.setForeground(new Color(0,0,0));
