...
public class Number_Base implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    // converting binary to hexa decimal
      ...
      // multiplying each digit by corresponding power of 2 and the n grouping the
      // resulting answers into groups of 4 to check the hex representation
      while (fromint > 0) {
    ...
    // converting decimal to binary
      ...
      // dividing by two and adding the remainders in reverse order where every digit
      // is is multiplied by the corresponding power of 2
      while (fromint != 0) {
        int rem = fromint % 2;
      ...
      // showing output when convert is pressed
      if (e.getSource() == done) {
        tobox.setText(Long.toString(b_number));
      }
    }
    ...
    // converting decimal to hexa decimal
      ...
      // dividing by 16 and adding the remainders in reverse order where every digit
      // is converted to its corresponding hex
      while (fromint > 0) {
        rem = fromint % 16;
